...
class DoctorProfileScreenView extends StatefulWidget {
  const DoctorProfileScreenView({super.key});

  @override
  State<DoctorProfileScreenView> createState() =>
      _DoctorProfileScreenViewState();
}

class _DoctorProfileScreenViewState extends State<DoctorProfileScreenView> {
